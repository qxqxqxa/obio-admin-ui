<template>
  <div class="mod-demo__news">
    <el-form :inline="true" :model="state.dataForm" @keyup.enter="state.getDataList()">
      ...
      <el-form-item>
        <el-input v-model="state.dataForm.title" :placeholder="$t('service.title')" clearable></el-input>
      </el-form-item>
    ...
    <el-table v-loading="state.dataListLoading" :data="state.dataList" border @selection-change="state.dataListSelectionChangeHandle" @sort-change="state.dataListSortChangeHandle" style="width: 100%">
      ...
      <el-table-column prop="title" :label="$t('service.title')" header-align="center" align="center" :show-overflow-tooltip="true"></el-table-column>
      <el-table-column prop="status" :label="$t('service.status')" header-align="center" align="center" width="150">
        <template v-slot="scope">
          {{ state.getDictLabel("articles_status", scope.row.status) }}
        </template>
      </el-table-column>
      <el-table-column prop="categoryName" :label="$t('service.category')" header-align="center" align="center"></el-table-column>
      <el-table-column prop="pubDate" :label="$t('service.pubDate')" header-align="center" align="center" width="180"></el-table-column>
      <el-table-column prop="sort" :label="$t('service.sort')" header-align="center" align="center" width="180"></el-table-column>
<!--      <el-table-column prop="username" :label="$t('service.creator')" header-align="center" align="center" width="180"></el-table-column>-->
...
const view = reactive({
  getDataListURL: "/cms/service/page",
  getDataListIsPage: true,
  deleteURL: "/cms/service",
  deleteIsBatch: true,
  daterange: null,
  dataForm: {
    title: "",
...
const init = () => {
  baseService.get("/cms/categories/list?type=0").then((res) => {
