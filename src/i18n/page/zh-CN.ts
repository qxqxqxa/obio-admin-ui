...
t.configInfo = {}
t.configInfo.name = "系统名称";
t.configInfo.copyright = "版权";
t.configInfo.logo = "系统logo";
t.configInfo.introduce = "系统介绍";
t.configInfo.remark = "备注";
t.configInfo.lan = "语言";
//服务
t.service = {}
t.service.title = "标题";
t.service.status = "状态";
t.service.category = "类别";
t.service.creator = "创建人";
t.service.pubDate = "发布时间";
t.service.keywords = "关键词";
t.service.createDate = "创建时间";
