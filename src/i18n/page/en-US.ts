...
t.home.sysInfo.nameVal = "security";
...
t.user = {};
t.user.username = "First Name";
t.user.deptName = "Department";
t.user.email = "Email";
t.user.mobile = "Telephone";
...
t.configInfo = {}
t.configInfo.name = "System name";
t.configInfo.copyright = "copyright";
t.configInfo.logo = "System logo";
t.configInfo.introduce = "introduce";
t.configInfo.remark = "remark";
t.configInfo.lan = "Language";
//服务
t.service = {}
t.service.title = "Title";
t.service.status = "Status";
t.service.category = "Category";
t.service.pubDate = "PublishTime";
t.service.creator = "Creator";
t.service.keywords = "Keywords";
t.service.createDate = "CreateDate";
